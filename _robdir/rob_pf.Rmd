...
## Análisis de regresión: relación entre la muerte del paciente 
...
###### Ajuste de modelo con todas las covariables seleccionadas (demográficas y fisiológicas)
```{r}
...
###### Ajuste de modelo para entender efecto del tratamiento para cada una de las muertes
```{r}
## Copia de datos originales
dfx <- df %>% 
